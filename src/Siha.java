...
public class Siha extends HavaAraclari {
	...
	private double denizVurusAvantaji = 10;

	Siha(double vurus, double dayaniklilik, String sinif, int seviyePuani, double karaVurusAvantaji, String altSinif) {

		super(vurus, dayaniklilik, sinif, seviyePuani, karaVurusAvantaji, altSinif);
	}

	public Siha clone() {
		return new Siha(this.getVurus(), this.getDayaniklilik(), this.getSinif(), this.getSeviyePuani(),
