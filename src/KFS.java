...
public class KFS extends KaraAraclari {
	...
	private double havaVurusAvantaji = 20;

	KFS(double vurus, double dayaniklilik, String sinif, int seviyePuani, double denizVurusAvantaji, String altSinif) {

		super(vurus, dayaniklilik, sinif, seviyePuani, denizVurusAvantaji, altSinif);
	}

	public KFS clone() {
		return new KFS(this.getVurus(), this.getDayaniklilik(), this.getSinif(), this.getSeviyePuani(),
				this.getDenizVurusAvantaji(), this.getAltSinif());
	}
