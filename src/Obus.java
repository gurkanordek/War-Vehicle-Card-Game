...
public class Obus extends KaraAraclari {
	...
	Obus(double vurus, double dayaniklilik, String sinif, int seviyePuani, double denizVurusAvantaji, String altSinif) {

		super(vurus, dayaniklilik, sinif, seviyePuani, denizVurusAvantaji, altSinif);
	}

	public Obus clone() {
		return new Obus(this.getVurus(), this.getDayaniklilik(), this.getSinif(), this.getSeviyePuani(),
