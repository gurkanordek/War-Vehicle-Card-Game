...
public class Firkateyn extends DenizAraclari {
	...
	Firkateyn(double vurus, double dayaniklilik, String sinif, int seviyePuani, double havaVurusAvantaji,
			String altSinif) {

		super(vurus, dayaniklilik, sinif, seviyePuani, havaVurusAvantaji, altSinif);
	}

	public Firkateyn clone() {
		return new Firkateyn(this.getVurus(), this.getDayaniklilik(), this.getSinif(), this.getSeviyePuani(),
