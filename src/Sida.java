...
public class Sida extends DenizAraclari {
	...
	private double karaVurusAvantaji = 10;

	Sida(double vurus, double dayaniklilik, String sinif, int seviyePuani, double havaVurusAvantaji, String altSinif) {

		super(vurus, dayaniklilik, sinif, seviyePuani, havaVurusAvantaji, altSinif);
	}

	public Sida clone() {
		return new Sida(this.getVurus(), this.getDayaniklilik(), this.getSinif(), this.getSeviyePuani(),
				this.getHavaVurusAvantaji(), this.getAltSinif());
	}
